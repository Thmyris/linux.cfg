...
COMPILE PEAZIP
PeaZip is developed in FreePascal using Lazarus development environment; to compile the application from source package and for any other information please refer to application's website https://www.peazip.org or https://peazip.sourceforge.io
